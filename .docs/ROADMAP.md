...
| 4 | **captur** — USB v4l2 / CSI live-capture as a video source, slot-mapped. *4a (live capture, no recording) shipped 2026-05-16 pending hardware verification; 4b (recording) pending* | ◐ | `src/capture/`, `src/video/pipeline_factory.rs` |
