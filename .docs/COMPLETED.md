...
- **Phase 2 sub-plan B — conjur UI + persistence**: SHADERS browser, SHDR_BNK shader bank, `shader_banks.toml`, `--gles-profile` CLI flag, hot-reload via `notify`, 4 starter shaders.
